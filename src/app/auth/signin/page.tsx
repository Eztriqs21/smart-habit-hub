  ...
  return (
    <div className="min-h-screen bg-bg flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 w-[300px] h-[300px] rounded-full bg-white/10 blur-[80px]" />
        <div className="absolute bottom-1/4 right-1/4 w-[200px] h-[200px] rounded-full bg-white/10 blur-[60px]" />
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <h2 className="text-4xl font-bold leading-tight mb-4">
            Welcome back to<br />your wellness journey
          </h2>
          <p className="text-lg text-white/80 leading-relaxed max-w-md">
            Continue building healthy habits across Body, Mind, and Lifestyle.
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <h1 className="text-title text-foreground mb-1">Welcome back</h1>
          <p className="text-sm text-text-secondary mb-8">Sign in to continue your journey</p>
          ...
          <form onSubmit={handleSignIn} className="flex flex-col gap-4">
            ...
            {error && (
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                className="text-[13px] text-error bg-error-light/50 px-3 py-2 rounded-lg"
              >
                {error}
              </motion.p>
            )}
