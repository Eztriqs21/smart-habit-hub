    ...
    <div className="min-h-screen bg-bg flex items-center justify-center px-4">
      <div className="w-full max-w-[400px]">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-foreground mt-6 mb-2">Create your account</h1>
          <p className="text-sm text-text-secondary">Start building better habits today</p>
        </div>
